...
1. Read the current Kanban task body and require exactly one object under `command`.
2. Call `pm_linear_execute` once with that exact command object. Do not rewrite, normalize, expand, or repair any field.
